...
public class IlanDetay extends AppCompatActivity {
    ...
    private ViewPager ilandevaySlider;
    String ilanId;
    ...
    public void tanimla() {
        ...
        ilandevaySlider = (ViewPager) findViewById(R.id.ilandevaySlider);
    ...
    public void getResim() {
        ...
        request.enqueue(new Callback<List<SliderPojo>>() {
            ...
            public void onResponse(Call<List<SliderPojo>> call, Response<List<SliderPojo>> response) {
                ...
                ilandevaySlider.setAdapter(sliderAdapter);
                circleIndicator.setViewPager(ilandevaySlider);
