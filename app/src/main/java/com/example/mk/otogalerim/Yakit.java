...
public class Yakit extends AppCompatActivity {
    ...
    public void ilaniYayinla(String ucret, String uye_id, String sehir, String ilce, String mahalle, String marka, String seri, String model, String yil, String ilantipi, String kimden, String baslik, String aciklama, String motortipi, String motorhacmi, String surat, String yakittipi, String ortalamayakit, String depohacmi, String km) {
        final Call<IlanSonucPojo> request = ManagerAll.getInstance().ilanVer(ucret, uye_id, sehir, ilce, mahalle, marka, seri, model, yil, ilantipi, kimden, baslik, aciklama, motortipi, motorhacmi, surat, yakittipi, ortalamayakit, depohacmi, km);
        request.enqueue(new Callback<IlanSonucPojo>() {
            ...
            public void onResponse(Call<IlanSonucPojo> call, Response<IlanSonucPojo> response) {
                if (response.body().isTf()) {
                    ...
                    Log.i("test 1 ", response.body().toString());
                    startActivity(ıntent);
