...
public class SliderAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        Picasso.with(context).load("http://192.168.1.2:8080/" + list.get(position).getResim()).resize(1050,550).into(ımageView);

        Log.i("bilgi","REsim Yolu"+list.get(position).getResim());
